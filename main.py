...
configure(api_key="AIzaSyBKCCicaw-iO2q3tQNQNN4PansQY9ljZZ8")
...
def create_ui():
    ...
    tk.Label(root, text="Enter Interests (comma separated):", font=("Arial", 14, "bold"), bg="#f0f8ff", fg="#333").pack(
        pady=5)
    interests_entry = tk.Entry(root, font=("Arial", 12), width=30)
    interests_entry.pack(pady=5)

    generate_btn = tk.Button(root, text="✨ Generate AI Itinerary ✨", font=("Arial", 14, "bold"), bg="#ff4500",
                             fg="white", command=get_itinerary)
    generate_btn.pack(pady=20)

    # Scrollable output box
    result_text = scrolledtext.ScrolledText(root, font=("Arial", 12), height=18, width=80, state=tk.DISABLED,
                                            wrap=tk.WORD, bg="#fffafa", fg="#333")
